...
class ControllerCatalogProduct extends Controller {
	...
	public function view_all() {
		...
		$this->get_productlist_with_multiVendors();
	}
	...
	public function get_productlist_with_multiVendors()
	{
		...
		$data['productLists_multiVendors'] = $this->url->link('catalog/product/productLists_multiVendors', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$results = $this->model_catalog_product->getProductsWithMultipleVendorsId($filter_data);
		...
		$this->response->setOutput($this->load->view('catalog/productlist_with_all_vendors', $data));
	}
	...
	protected function getList() {
		...
		$data['view_all'] = $this->url->link('catalog/product/view_all', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['add'] = $this->url->link('catalog/product/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['copy'] = $this->url->link('catalog/product/copy', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/product/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
